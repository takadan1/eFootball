class Match < ApplicationRecord
 ...
 with_options inclusion: { in: 0..4 } do
  validates :gf_counter, :gf_cross, :gf_one_two, :gf_long_shot, 
       :gf_dribble, :gf_build_up, :gf_accident, :gf_throughpass, :gf_other,
       :ga_counter, :ga_cross, :ga_one_two, :ga_long_shot, 
       :ga_dribble, :ga_build_up, :ga_accident, :ga_throughpass, :ga_other
 end
 validates :result, presence: true
 def goals_for
  gf_counter + gf_cross + gf_one_two + gf_long_shot + gf_dribble + gf_build_up + gf_accident + gf_throughpass + gf_other
 end
 def goals_against
  ga_counter + ga_cross + ga_one_two + ga_long_shot + ga_dribble + ga_build_up + ga_accident + ga_throughpass + ga_other
 end
 ...
 GF_REASONS = {
  ...
  gf_dribble: "ドリブル", gf_build_up: "パス回し", gf_accident: "事故", gf_throughpass:"裏抜け", gf_other: "その他"
 }.freeze
 GA_REASONS = {
  ga_counter: "カウンター", ga_cross: "クロス", ga_one_two: "ワンツー", ga_long_shot: "ミドルシュート",
  ga_dribble: "ドリブル", ga_build_up: "パス回し", ga_accident: "事故", ga_throughpass:"裏抜け", ga_other: "その他"
 }.freeze
end